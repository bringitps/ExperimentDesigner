...
public class FinalPassYieldReportDataDesign extends VerticalLayout {
	protected Label lblFnyRptTitle;
	...
	protected ComboBox cbxFnyFieldFilter;
	protected TextField txtExpFieldFilter;
	protected Button btnExportExcel;
	protected Table tblFnyDataReport;

	public FinalPassYieldReportDataDesign() {
		Design.read(this);
	}
}
