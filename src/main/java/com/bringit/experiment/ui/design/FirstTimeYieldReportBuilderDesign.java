...
public class FirstTimeYieldReportBuilderDesign extends VerticalLayout {
	...
	protected TextField txtFtyRptPassValue;
	protected TextField txtFtyRptFailValue;
	...
	public FirstTimeYieldReportBuilderDesign() {
		Design.read(this);
	}
}
