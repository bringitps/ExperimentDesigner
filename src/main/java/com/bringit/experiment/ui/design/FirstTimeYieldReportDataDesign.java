...
public class FirstTimeYieldReportDataDesign extends VerticalLayout {
	protected Label lblFtyRptTitle;
	...
	protected ComboBox cbxFtyFieldFilter;
	protected TextField txtExpFieldFilter;
	protected Button btnExportExcel;
	protected Table tblFtyDataReport;

	public FirstTimeYieldReportDataDesign() {
		Design.read(this);
	}
}
