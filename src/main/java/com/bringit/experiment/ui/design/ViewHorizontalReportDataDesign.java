...
public class ViewHorizontalReportDataDesign extends VerticalLayout {
	protected Label lblVwHorizontalRptTitle;
	...
	protected ComboBox cbxVwHorizontalFieldFilter;
	protected TextField txtExpFieldFilter;
	protected Button btnExportExcel;
	protected Table tblVwHorizontalDataReport;

	public ViewHorizontalReportDataDesign() {
		Design.read(this);
	}
}
