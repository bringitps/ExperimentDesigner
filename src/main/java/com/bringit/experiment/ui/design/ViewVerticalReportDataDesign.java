...
public class ViewVerticalReportDataDesign extends VerticalLayout {
	protected Label lblVwVerticalRptTitle;
	...
	protected ComboBox cbxVwVerticalFieldFilter;
	protected TextField txtExpFieldFilter;
	protected Button btnExportExcel;
	protected Table tblVwVerticalDataReport;

	public ViewVerticalReportDataDesign() {
		Design.read(this);
	}
}
